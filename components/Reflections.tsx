...
const PostCard: React.FC<{ imageUrl: string; title: string; excerpt: string }> = ({ imageUrl, title, excerpt }) => (
    <div className="bg-white rounded-xl shadow-md overflow-hidden group hover:shadow-xl transition-shadow duration-300">
        ...
        <div className="p-5">
            ...
            <a href="#" onClick={(e) => e.preventDefault()} className="text-sm font-semibold text-[#1a3a63] hover:underline mt-3 inline-block">Leer más &rarr;</a>
        </div>
    </div>
);
